        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNum = table.Column<string>(maxLength: 64, nullable: true),
                    Image = table.Column<string>(maxLength: 255, nullable: true),
                    YearWorked = table.Column<string>(nullable: true),
                    DayWorked = table.Column<string>(nullable: true),
                    TotalAnnualRight = table.Column<int>(nullable: false),
                    YearlyAnnualRightCount = table.Column<int>(nullable: false),
                    AvailableTotalLeaves = table.Column<int>(nullable: false),
                    UsedTotalLeaves = table.Column<int>(nullable: false),
                    RecruitmentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsOnLeave = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualRights = table.Column<int>(nullable: false),
                    Used = table.Column<int>(nullable: false),
                    LeftDate = table.Column<int>(nullable: false),
                    IsOnLeave = table.Column<bool>(nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAnnualDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeAnnualDetails_Employee",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeSpecialLeaves_Employee",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAnnualDetails_EmployeesId",
                table: "EmployeeAnnualDetails",
                column: "EmployeesId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSpecialLeaves_EmployeeId",
